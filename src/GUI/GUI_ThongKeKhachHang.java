...
//		pnlThongKeKhachHang.setBorder(new TitledBorder(null, "Thông tin khách hàng"));
		...
		pnlThongKeKhachHang.add(lblMaKhachHang);
		
		txtMaKhachHang = new JTextField();
//		txtMaKhachHang.setEditable(false);
        txtMaKhachHang.setBounds(110, 25, 250, 25);
        pnlThongKeKhachHang.add(txtMaKhachHang);
        txtMaKhachHang.setColumns(10);
		
        
        lblTenKhachHang = new JLabel("Tên khách hàng:");
        lblTenKhachHang.setBounds(390, 20, 100, 30);
        pnlThongKeKhachHang.add(lblTenKhachHang);
        
        txtTenKhachHang = new JTextField();
        txtTenKhachHang.setBounds(490, 25, 250, 25);
        pnlThongKeKhachHang.add(txtTenKhachHang);
        ...
        JScrollPane scroll;
        String[] headers = {"Mã HD", "Mã Phòng", "Loại Phòng", "Giá Phòng", "Ngày CheckIn","Ngày CheckOut","Số ngày","Thành tiền","Mã KH","Tên KH"};
